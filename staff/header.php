    ...
    <div class="container-fluid"> <a class="navbar-brand" href="#"><img width="50" class="img=fluid" src="../image/bg-2.png" /></a> <button class="navbar-toggler text-warning" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation"> <i class="fas fa-ellipsis-v"></i> </button>
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav"> <a class="nav-link text-warning" href="index.php"> <i class="fas fa-concierge-bell"></i> <span>Home</span> </a> <?php if ($_SESSION['user_role'] == "waiters") {
                                                                                                                                                        ...
                                                                                                                                                        } ?> <a class="nav-link text-warning" href="https://www.hockeycomputindo.com/2021/05/restaurant-pos-source-code-free.html" target="_blank"> <i class="fas fa-book"></i> <span>Documentation</span> </a> <a class="nav-link text-warning" href="#" data-toggle="modal" data-target="#logoutModal"> <i class="fas fa-power-off"></i> <span>Off</span> </a></div>
        </div>
    </div>
</nav>
<div class="container">
